...
# 在[init, final]上取一个值，由t在[tmin, tmax]中的位置决定
...
class Periodic_1d(TimeSeries):
    def __init__(self, device=torch.device("cpu"),
                 ...
                 z0=0.):
        """
		If some of the parameters (init_freq, init_amplitude, final_amplitude, final_freq) is not provided,
